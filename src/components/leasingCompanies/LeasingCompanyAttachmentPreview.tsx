...
import type { LeasingCompanyAttachment, LeasingCompanyAttachmentPreviewProps } from '../../types/leasingCompanies';

const LeasingCompanyAttachmentPreview: React.FC<LeasingCompanyAttachmentPreviewProps> = ({ attachment, onView, onDelete }) => {
  ...
  const getFileTypeIcon = (attachment: LeasingCompanyAttachment): string => {
...
export default LeasingCompanyAttachmentPreview;
