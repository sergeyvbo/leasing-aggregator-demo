...
import type { UserVersionComponentProps } from '../../types/users';
...
/**
 * UserVersionComponent provides navigation between different versions of a user
 * Shows version number, date, status and navigation arrows
 */
export const UserVersionComponent: React.FC<UserVersionComponentProps> = ({
  version,
  onVersionChange,
  onEditStart,
  onEditEnd
...
export default UserVersionComponent;
