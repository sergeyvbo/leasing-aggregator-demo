...
import type { BrokerAttachment, BrokerAttachmentPreviewProps } from '../../types/brokers';

const BrokerAttachmentPreview: React.FC<BrokerAttachmentPreviewProps> = ({ attachment, onView, onDelete }) => {
  ...
  const getFileTypeIcon = (attachment: BrokerAttachment): string => {
...
export default BrokerAttachmentPreview;
