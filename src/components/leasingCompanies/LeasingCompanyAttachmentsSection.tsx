...
import type { LeasingCompanyAttachmentsSectionProps } from '../../types/leasingCompanies';

const LeasingCompanyAttachmentsSection: React.FC<LeasingCompanyAttachmentsSectionProps> = ({
  attachments,
  onAddAttachment,
  onDeleteAttachment
}) => {
...
export default LeasingCompanyAttachmentsSection;
