...
export const templateCollectionsData: TemplateCollection[] = [
  {
    ...
    templateNames: 'Шаблон VIN-кода; Шаблон технических характеристик',
    version: {
      id: 'v1',
      number: 1,
      status: 'active',
...
export const templatesData: Template[] = [
  ...
  },
  {
    ...
    type: 'Легковые автомобили',
    keyIdentifier: '',
    additionalAttributes: 'Мощность; Крутящий момент; Расход топлива; Тип привода; Марка; Модель; Год выпуска; Цвет; Объем двигателя',
    version: {
      id: 'v1',
      number: 1,
      status: 'active',
