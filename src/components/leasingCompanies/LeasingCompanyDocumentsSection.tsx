...
import LeasingCompanyDocumentModal from './LeasingCompanyDocumentModal';

interface LeasingCompanyDocumentsSectionProps {
...
export const LeasingCompanyDocumentsSection: React.FC<LeasingCompanyDocumentsSectionProps> = ({
  documents, 
  version, 
  onVersionChange,
  onAddDocument,
  ...
  const [selectedDocument, setSelectedDocument] = useState<LeasingCompanyDocument | undefined>(undefined);
  ...
  const handleSaveDocument = (document: LeasingCompanyDocument) => {
        ...
        <div className="flex items-start justify-between">
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs md:text-sm text-gray-600 mt-1 break-words">
              Документооборот и регистрационные данные лизинговой компании
            </p>
          </div>
        </div>
      ...
      <div className="px-4 md:px-6 py-4 md:py-6">
        ...
        {!documents || documents.length === 0 ? (
          <EmptyState
            ...
            description="У данной лизинговой компании пока нет загруженных документов"
          />
        ) : (
...
export default LeasingCompanyDocumentsSection;
