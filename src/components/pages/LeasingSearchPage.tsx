        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {filters.map((filter) => (
                <div key={filter.id} className="flex space-x-4 items-center bg-gray-50 p-4 rounded-lg">
                  <select
              ...
              <div key={product.id} className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">{product.company}</h4>
                  ...
                  <button
                    onClick={onShowModal}
                    className="ml-6 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center"
                  >
